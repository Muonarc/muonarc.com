...
**Overnight rule (Atlas, 9:06 PM PT Sep 1, 2026):** Atlas does **not** create the live Stripe product overnight. Click-path only. Do **not** rewrite `drafts/notes-first-cot-pack-checkout-2026-08-30.md` or `drafts/notes-first-morning-hitl-2026-09-01.md` already on this branch. Other files untouched. This file lands on `cursor/notes-surface-a3e9` only. Not main. Not merged. Not a live checkout.

**SKU:** First SKU is **Friday COT Pack** (Candidate 2 only; 12 liquid futures, CFTC public) per already-landed COT checkout `drafts/notes-first-cot-pack-checkout-2026-08-30.md` SHA `5a5c5000e2ef4ada6617ee6fe3f487598d8b6c34` and morning card `drafts/notes-first-morning-hitl-2026-09-01.md` SHA `67d60b6bb044612b4443dd8525aba92b66ce4b3b`. Not candidates 1 or 3. Not the $40 hospital MRF-change extract. Not Ko-fi. Not GitHub storefront. Not a muonarc.com live path.
...
**Paste-fields source (read-only, already on this branch, commit SHA `5a5c5000e2ef4ada6617ee6fe3f487598d8b6c34`):** `drafts/notes-first-cot-pack-checkout-2026-08-30.md`  
...
**Morning card (read-only, already on this branch, commit SHA `67d60b6bb044612b4443dd8525aba92b66ce4b3b`):** `drafts/notes-first-morning-hitl-2026-09-01.md`  
Do not rewrite that morning card.
...
## PASTE fields (from SHA `5a5c5000` — not live)
...
**Band from SHA `5a5c5000` / morning card `67d60b6b`:** **$12–$25 / Friday pack**, or **$20–$40 / month retain** (4 packs).
...
Suggested `after_completion` type from SHA `5a5c5000`: `hosted_confirmation` (or custom URL later). No live URL in this file.
...
- File: `drafts/notes-first-cot-stripe-clickpath-2026-09-01.md` on `cursor/notes-surface-a3e9` only. Not main. Not merged.
- Click-path only. Not a live Stripe product. Atlas does **not** create the live product overnight.
- Paste-fields copied from `drafts/notes-first-cot-pack-checkout-2026-08-30.md` SHA `5a5c5000e2ef4ada6617ee6fe3f487598d8b6c34`. That checkout draft is **untouched**.
...
- First SKU: Friday COT Pack. Not a live product.
