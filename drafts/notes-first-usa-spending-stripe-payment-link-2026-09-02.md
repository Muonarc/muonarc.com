...
**Wait rule (7am card SHA `fb830d06`):** USA Payment Link **waits until COT has a real live link.** Do not walk this checklist in the Dashboard before the Friday COT Pack Payment Link exists. Overnight Rogue does not log in to Stripe.
...
Same 7am Benjamin checklist shape as `drafts/notes-first-cot-stripe-payment-link-2026-09-02.md` (SHA `898bbfe2`).
...
10. **Post-pay (first paid USA checkout):** fulfill with `drafts/notes-first-usa-spending-fulfillment-email-2026-09-01.md`. Template only. Do **not** send the email overnight. Wait for a real paid checkout, then Atlas / Benjamin sends. Mirrors COT checklist SHA `898bbfe2`.
11. Confirm **NCUA stays wait.** Do **not** paste `drafts/notes-first-live-note-ncua-title12-2026-09-02.md` (`edac1ff7`) and do **not** create an NCUA Stripe product until USA has a real Payment Link.
...
- Redo COT checklist SHA `898bbfe2` / cash-first index SHA `fb830d06` / open stale morning-hitl SHA `9bc569a3`
...
- Send email / post / cold email / second emails on killed rails (including the USA fulfillment template)
