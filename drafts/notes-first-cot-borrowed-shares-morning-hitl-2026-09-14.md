# HITL morning card — Friday COT Pack borrowed shares (2026-09-14)
...
**Status:** HITL / Atlas+Benjamin morning card for **2026-09-14**. **NEW file** — does **not** refresh frozen Sep-13 @ notes SHA `d20b220c` (or older Sep-11/10/9/8/7 cards). **DO-NOT-POST** until Atlas / Benjamin says. Rogue does not post, email, mutate Pages, or open frozen rails.
...
**Recommended post:** this Ready paste only (borrowed-distribution draft). Do not invent a second venue until Atlas greens backlog.
...
- Refresh frozen Sep-13 @ `d20b220c` (or older morning cards)
