...
**Full order** (mid/late pack and the rest): runbook v18 `drafts/notes-first-cot-friday-launch-runbook-v18-2026-09-18.md` @ notes **`d0e579a4`** (supersedes v17 `7a87f344` / v16 `057a7266` / v15 `6c9518db` / v14 `7dca1899` / v13 `f2b59c3b` / v12 `97cbbd2b` / v11 `3ee6945b` / v10 `add75747` / v8 `7dc9a351` / v7 `bcfccce4` / v6 `b21209fb` / v5 `aefdb730` / v4 `51e19f9c` / v3 `213c8b5a` — cite only).

**Defer** mid/late pack unless Benjamin greens more time.

**Optional mid/later pack (forum/quant pack — not first-wave):** Futures.io `f5dbb0aa` → Trade2Win `739b3932` → Elite Trader `80dd5e3d` → QuantConnect `c76aea1d` → NinjaTrader `468e18f5` → BabyPips `45a19f38` → Forex Factory `4080e743` → TradeStation `bafbd51e` → Multicharts `518857ff` (`17f0d156` sibling) → Sierra Chart `038bb9c9` → thinkorswim `798e8f22` → IBKR `57da57b7` → tastytrade `8b0aa0d1` → Tradovate `35b37c31` → AMP Futures `be56e5c7` — drafted but **deferred** from first-wave unless Benjamin expands. Cite only; do not rewrite those blobs.
...
- **FREEZE untouched this commit:** tip morning HITL `9fecc45a`; fulfill `91aaacd3`; runbook v18 `d0e579a4` content (cite only); prior runbooks (v17 `7a87f344` / v16 `057a7266` / v15 `6c9518db` / v14 `7dca1899` / v13 `f2b59c3b` / v12 `97cbbd2b` / v11 `3ee6945b` / v10 `add75747` / v8 `7dc9a351` / v7 `bcfccce4` / v6 `b21209fb` / v5 `aefdb730` / v4 `51e19f9c` / v3 `213c8b5a` superseded — cite only); all channel drafts through AMP Futures `be56e5c7` (forum/quant pack Futures.io `f5dbb0aa` / Trade2Win `739b3932` / Elite Trader `80dd5e3d` / QuantConnect `c76aea1d` / NinjaTrader `468e18f5` / BabyPips `45a19f38` / Forex Factory `4080e743` / TradeStation `bafbd51e` / Multicharts `518857ff` / `17f0d156` / Sierra Chart `038bb9c9` / thinkorswim `798e8f22` / IBKR `57da57b7` / tastytrade `8b0aa0d1` / Tradovate `35b37c31` / AMP Futures `be56e5c7` — cite only); main `606b300a`.
...
- Mid/late pack or forum/quant pack (Futures.io / Trade2Win / Elite Trader / QuantConnect / NinjaTrader / BabyPips / Forex Factory / TradeStation / Multicharts / Sierra Chart / thinkorswim / IBKR / tastytrade / Tradovate / AMP Futures) unless Benjamin expands
