...
**Status:** HITL draft. Not published. Not live. **Do not create the live Stripe product, Price, or Payment Link overnight.** Paste-ready success + cancel page copy only. Atlas drops these into Stripe Dashboard later when creating the COT Payment Link from `drafts/notes-first-cot-stripe-clickpath-2026-09-01.md` / checkout `drafts/notes-first-cot-pack-checkout-2026-08-30.md` (commit SHA `5a5c5000e2ef4ada6617ee6fe3f487598d8b6c34` or live path). No Stripe login. No live SKU. No `buy.stripe.com` URL. No Ko-fi. No Gumroad. No GitHub paid storefront.

**Overnight rule (Atlas, 9:10 PM PT Sep 1, 2026):** Atlas does **not** create the live Stripe product overnight. Success + cancel paste copy only. Lands on `cursor/notes-surface-a3e9` only. Not main. Not merged. Other files untouched (click-path, checkout sheet, morning card stay as-is). Do **not** rewrite `drafts/notes-first-cot-stripe-clickpath-2026-09-01.md`, `drafts/notes-first-cot-pack-checkout-2026-08-30.md`, or `drafts/notes-first-morning-hitl-2026-09-01.md` already on this branch.
...
- Click-path (already on this branch): `drafts/notes-first-cot-stripe-clickpath-2026-09-01.md` SHA `f4a6833f93aba895ec7faa3ab11df4a844da899a`
- Checkout paste-fields (already on this branch): `drafts/notes-first-cot-pack-checkout-2026-08-30.md` commit SHA `5a5c5000e2ef4ada6617ee6fe3f487598d8b6c34`
- Morning card (already on this branch): `drafts/notes-first-morning-hitl-2026-09-01.md` SHA `67d60b6bb044612b4443dd8525aba92b66ce4b3b`
- Fulfillment email: not on this branch; not created; not rewritten.
...
Copy each labeled block into the matching Stripe Payment Link field **later**, when creating the COT Payment Link from `drafts/notes-first-cot-stripe-clickpath-2026-09-01.md` / checkout SHA `5a5c5000e2ef4ada6617ee6fe3f487598d8b6c34` (or live checkout path `drafts/notes-first-cot-pack-checkout-2026-08-30.md`). Atlas does **not** paste these overnight. **Do not click Create link. Do not create the live product.**
...
**Band from checkout SHA `5a5c5000e2ef4ada6617ee6fe3f487598d8b6c34` / morning card `67d60b6bb044612b4443dd8525aba92b66ce4b3b`:** **$12–$25 / Friday pack**, or **$20–$40 / month retain** (4 packs).
...
- File: `drafts/notes-first-cot-success-cancel-2026-09-01.md` on `cursor/notes-surface-a3e9` only. Not main. Not merged.
...
- Click-path `drafts/notes-first-cot-stripe-clickpath-2026-09-01.md` SHA `f4a6833f93aba895ec7faa3ab11df4a844da899a` is **untouched**.
- Checkout `drafts/notes-first-cot-pack-checkout-2026-08-30.md` SHA `5a5c5000e2ef4ada6617ee6fe3f487598d8b6c34` is **untouched**.
- Morning card `drafts/notes-first-morning-hitl-2026-09-01.md` SHA `67d60b6bb044612b4443dd8525aba92b66ce4b3b` is **untouched**.
